...
function isClicked(i){
    ...
    if (dateIsClicked===false){   
        ...
        const selectedDate = new Date(currYear, currMonth, i+2); // Create a new Date object with the selected day, month, and year
        const formattedDate = selectedDate.toISOString().split('T')[0]; // Convert the date to ISO format (YYYY-MM-DD)
